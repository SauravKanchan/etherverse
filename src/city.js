...
export const createBuilding = (map) => {
  ...
  setOnMap(map, BUILDING_START.x+Math.floor(BUILDING_DIMENSION.width/2), BUILDING_START.y+BUILDING_DIMENSION.height+1, "e")
  setOnMap(map, BUILDING_START.x+Math.floor(BUILDING_DIMENSION.width/2)-1, BUILDING_START.y+BUILDING_DIMENSION.height+1, "e")
  setOnMap(map, BUILDING_START.x+Math.floor(BUILDING_DIMENSION.width/2)+1, BUILDING_START.y+BUILDING_DIMENSION.height+1, "e")
